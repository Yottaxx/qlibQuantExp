"""CSI300 HSF: ref-all relative-complexity macro state without day summary."""
...
model_config["global_state_use_day_summary"] = False
model_config["router_summary_source"] = "none"
model_config["pooling_summary_source"] = "none"
